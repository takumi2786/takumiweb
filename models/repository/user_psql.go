...
func (r UserRepository) GetAll() ([]UserProfile, error) {
	db := db.GetDB()
	var u []UserProfile
...
func (r UserRepository) CreateModel(c *gin.Context) (User, error) {
	db := db.GetDB()
	var u User
...
func (r UserRepository) UpdateByID(id int, c *gin.Context) (models.User, error) {
	db := db.GetDB()
	var u models.User
